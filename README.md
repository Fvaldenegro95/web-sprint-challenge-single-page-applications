...
useRouteMatch allows you to add nested routes , without having to change the rest of your URL right on your app. We use things like ${url} and ${path} to help promote clean code.

1. How would you explain form validation to someone who has never programmed before?

Validation is making sure the human aspect is 1 to 1 with what the computer is expecting, it translates it to make sure that it can send back the info we require.

1. In 1-2 sentences, define end to end testing.

End to end testing is used to test the actual use of our software. It simulates a live user experience from the client's point of view, so we can better understand them, it can reveal any bugs or errors that a real user may encounter in the process.
